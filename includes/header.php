...
<body>
    <nav class="navbar">
        <div class="nav-container">
            ...
            <div class="nav-links">
                <a href="<?php echo BASE_URL; ?>index.php" class="nav-link">Play</a>
                ...
                <?php if (isLoggedIn()): ?>
                    ...
                    <?php endif; ?>
                    <div class="nav-user">
                        <img src="<?php echo BASE_URL; ?>assets/uploads/profiles/<?php echo getCurrentUserPhoto(); ?>" alt="Profile" class="nav-avatar">
